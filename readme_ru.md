...
*Установить время запуска инстанции по рабочим дням в 7 часов утра*
На выбранной инстанции установить:
- тег ```bash-starttime```, значение 07-00
- тег ```bash-profile```, значение ```wd```

*Установить время остановки инстанции ежедневно в 9 часов вечера*
На выбранной инстанции установить:
- тег ```bash-stoptime```, значение 21-00
- тег ```bash-profile```, значение ```ad```

*Установить время перезапуска инстанции ежедневно в 3 часа ночи*
На выбранной инстанции установить:
