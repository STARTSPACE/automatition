...
Да, без ограничений. Мы их создавали как пример автоматизации использования инфраструктуры Amazon Web Services. Если Вы заинтересованы в более глубокой интеграции с Вашей инфосистемой, то связывайтесь с нами по [электронной почте ```contact@startspace.ru```] (mailto:contact@startspace.ru), постараемся помочь.
